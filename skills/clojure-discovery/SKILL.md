...
When writing Clojure code with unfamiliar APIs, gather context before writing. This skill focuses on **Java interop** and **macros** (for general function exploration, use [[clojure-fast-read]]).
